...
#define STRING_CONFIG_H_AUTHOR "(Greg Barpa, Anycubic Chiron config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Chiron
  #define DEFAULT_bedKp  90.64
  #define DEFAULT_bedKi  14.18
  #define DEFAULT_bedKd 386.13
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 100, 400, 105 }
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 300, 35, 50 } // ...or, set your own edit limits
#endif
